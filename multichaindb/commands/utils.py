...
import multichaindb
import multichaindb.config_utils
from multichaindb.version import __version__


def configure_multichaindb(command):
    """Decorator to be used by command line functions, such that the
    configuration of multichaindb is performed before the execution of
    the command.
    ...
    def configure(args):
        ...
        try:
            ...
            pass
        multichaindb.config_utils.autoconfigure(
...
base_parser = argparse.ArgumentParser(add_help=False, prog='multichaindb')
