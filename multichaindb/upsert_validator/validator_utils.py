...
from multichaindb.common.exceptions import InvalidPublicKey, MultiChainDBError
...
def encode_validator(v):
    ...
    try:
        version = TmVersion(multichaindb.config["tendermint"]["version"])
    except ValueError:
        raise MultiChainDBError('Invalid tendermint version, '
