...
def get_multichaindb_config_value(key, default_value=None):
    return multichaindb.config['database'].get(key, default_value)


def get_multichaindb_config_value_or_key_error(key):
    return multichaindb.config['database'][key]
