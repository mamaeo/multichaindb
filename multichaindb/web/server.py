...
from multichaindb import utils
from multichaindb import MultiChainDB
from multichaindb.web.routes import add_routes
from multichaindb.web.strip_content_type_middleware import StripContentTypeMiddleware
...
class StandaloneApplication(gunicorn.app.base.BaseApplication):
    ...
    def load_config(self):
        ...
        config['default_proc_name'] = 'multichaindb_gunicorn'
...
def create_app(*, debug=False, threads=1, multichaindb_factory=None):
    ...
    app.config['multichain_pool'] = utils.pool(multichaindb_factory, size=threads)
...
def create_server(settings, log_config=None, multichaindb_factory=None):
    ...
    app = create_app(debug=settings.get('debug', False),
                     ...
                     multichaindb_factory=multichaindb_factory)
